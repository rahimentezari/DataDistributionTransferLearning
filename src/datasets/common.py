...
# def get_features(is_train, image_encoder, dataset, train_loader, test_loader, device):
def get_features(args, is_train, image_encoder, train_loader, test_loader, device):
    # split = 'train' if is_train else 'val'
    # print("=====================================================================", split)
    # dname = type(args.train_dataset).__name__
    # print("image_encoder.cache_dir ", image_encoder.cache_dir )
...
class FeatureDataset(Dataset):
    def __init__(self, args, is_train, image_encoder,  train_loader, test_loader, device):
        # print("============================================================================================")
        # print(image_encoder)
        self.data = get_features(args, is_train, image_encoder,  train_loader, test_loader,  device)
...
def get_dataloader(train_loader, test_loader, is_train, args, image_encoder=None):
    if image_encoder is not None:
        feature_dataset = FeatureDataset(args, is_train, image_encoder, train_loader, test_loader, args.device)
        dataloader = DataLoader(feature_dataset, batch_size=args.batch_size, shuffle=is_train)
    else:
        dataloader = train_loader if is_train else test_loader
    return dataloader
...
#     image_encoder.eval()
#
#     # print("final image_encoder", image_encoder)
#
#     with torch.no_grad():
#         for batch in tqdm(dataloader):
#             batch = maybe_dictionarize(batch)
...
#
# # def get_features(is_train, image_encoder, dataset, train_loader, test_loader, device):
# def get_features(is_train, image_encoder, train_loader, test_loader, device):
#     # split = 'train' if is_train else 'val'
...
#
# class FeatureDataset(Dataset):
#     def __init__(self, is_train, image_encoder, dataset,  train_loader, test_loader, device):
#         # print("============================================================================================")
#         # print(image_encoder)
#         self.data = get_features(is_train, image_encoder, dataset,  train_loader, test_loader,  device)
#
#     def __len__(self):
#         return len(self.data['features'])
#
